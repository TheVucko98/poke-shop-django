...
INSERT INTO django_content_type VALUES (1,'admin','logentry'),(3,'auth','group'),(2,'auth','permission'),(4,'contenttypes','contenttype'),(8,'PSI_DUCK','informacijeporudzbine'),(12,'PSI_DUCK','istorijakupovine'),(11,'PSI_DUCK','jeocenio'),(6,'PSI_DUCK','karta'),(9,'PSI_DUCK','korpa'),(10,'PSI_DUCK','listazelja'),(7,'PSI_DUCK','registrovankorisnik'),(5,'sessions','session');
...
INSERT INTO django_session VALUES ('48d1208e64dt2andbf8y3pghy1qscc0v','.eJxVjEEOwiAQRe_C2hCm7VB06b5nIMwMSNVAUtqV8e7apAvd_vfefykftjX7rcXFz6IuCtTpd6PAj1h2IPdQblVzLesyk94VfdCmpyrxeT3cv4McWv7WZ4GOiIzl3o4SBzTWBgeAJqGTZB1SisahY2DokRNBnzozoAuMYwT1_gDafTea:1sCmi2:XBU_MGDsH5hpe-gZ_n5CunY2Usef_8Wp8MvG-37x8DE','2024-06-13 20:49:14.068538'),('f3bvwmo5q9xe9ymjw3hovlslen62oi9w','.eJxVjEEOwiAQRe_C2hCm7VB06b5nIMwMSNVAUtqV8e7apAvd_vfefykftjX7rcXFz6IuCtTpd6PAj1h2IPdQblVzLesyk94VfdCmpyrxeT3cv4McWv7WZ4GOiIzl3o4SBzTWBgeAJqGTZB1SisahY2DokRNBnzozoAuMYwT1_gDafTea:1sBtpS:rjO1TNNIqntvKSFlzNJU5KdZ7irUif-b-bJTSbg9byA','2024-06-11 10:13:14.726377');
...
INSERT INTO informacijeporudzbine VALUES (1,'2024-05-28','','','Default Address','Default City','Default Country',2,'10:12:40.288922'),(2,'2024-05-28','','','','','',1,'10:12:40.288922');
/*!40000 ALTER TABLE informacijeporudzbine ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `istorijakupovine`
--

DROP TABLE IF EXISTS istorijakupovine;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE istorijakupovine (
  ...
  korisnik_id bigint NOT NULL,
  PRIMARY KEY (id),
  KEY IstorijaKupovine_karta_id_580f06ce_fk_Karta_id (karta_id),
  KEY IstorijaKupovine_korisnik_id_d7ed9119_fk_RegistrovanKorisnik_id (korisnik_id),
  CONSTRAINT IstorijaKupovine_karta_id_580f06ce_fk_Karta_id FOREIGN KEY (karta_id) REFERENCES karta (id),
  CONSTRAINT IstorijaKupovine_korisnik_id_d7ed9119_fk_RegistrovanKorisnik_id FOREIGN KEY (korisnik_id) REFERENCES registrovankorisnik (id)
) ENGINE=InnoDB AUTO_INCREMENT=11 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `istorijakupovine`
--

LOCK TABLES istorijakupovine WRITE;
/*!40000 ALTER TABLE istorijakupovine DISABLE KEYS */;
INSERT INTO istorijakupovine VALUES (1,1,'2024-05-28','10:45:11.168366',3,2),(2,2,'2024-05-28','10:45:42.553985',3,2),(3,3,'2024-05-28','10:46:23.465874',3,2),(4,5,'2024-05-28','10:47:54.793171',1,2),(5,2,'2024-05-28','10:47:54.795790',2,2),(6,1,'2024-05-28','10:51:22.622533',1,2),(7,2,'2024-05-28','10:51:22.626495',2,2),(8,2,'2024-05-28','11:11:08.340872',3,1),(9,1,'2024-05-29','15:22:14.025116',1,1),(10,1,'2024-05-29','15:22:14.029115',3,1);
/*!40000 ALTER TABLE istorijakupovine ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO jeocenio VALUES (1,-1,3,1),(2,1,2,1);
...
INSERT INTO karta VALUES (1,'Pikachu',213,'Munjeviti pokemon',4,0,0,'imgs/pikachu_aYIqWog.png',0),(2,'Onix',70,'asdfasf',5,1,0,'imgs/onix.png',35),(3,'PsyDuck',80,'UltraSound pokemon, super cool',3,0,1,'imgs/psyduck.png',0),(4,'charizard',1251,'asdfasdfasdfsdafasdfasdfasdfasdfasdfsdafasdfasdfasdfasdfasdfsdafasdfasdfasdfasdfasdfsdafasdfasdfasdfasdfasdfsdafasdfasdfasdfasdfasdfsdafasdfasdfasdfasdfasdfsdafasdfasdfasdfasdfasdfsdafasdfasdfasdfasdfasdfsdafasdfasdf',1,0,0,'imgs/charizard.jpg',0);
...
INSERT INTO registrovankorisnik VALUES (1,'pbkdf2_sha256$720000$vJvGYQDXvhP2gptBRFiXsV$S9ck70BKr6ieJljC2KOB0cglLR1t3EYCO+caD5/48ps=','2024-05-30 20:49:14.064411',1,'admin','','','',1,1,'2024-05-27 22:23:30.000000','imgs/logo_89np68g.png'),(2,'pbkdf2_sha256$720000$Ok9KdfAwI500ZtohvAIqlk$sKXSZg0N0HQJJ5Q7ZbwoGjHL/M/nJjW7X8Wx9P/2j6k=','2024-05-29 16:36:24.605397',0,'nikola123','','','',0,1,'2024-05-27 22:24:43.000000','imgs/logo_76kwdcY.png');
...
-- Dump completed on 2024-05-31 17:14:47
